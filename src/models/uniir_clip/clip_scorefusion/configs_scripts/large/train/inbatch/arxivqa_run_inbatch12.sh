...
export CUDA_VISIBLE_DEVICES=4 # <--- Change this to the CUDA devices you want to us
NPROC=1
...
python -m torch.distributed.run --master_port 29503 --nproc_per_node=$NPROC $SCRIPT_NAME \
